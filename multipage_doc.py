...
class DocumentProcessor:
    ...
    def __init__(self, role, bucket, document):
        self.roleArn = "arn:aws:iam::001464217116:role/textract-role"
        self.snsTopicArn = "arn:aws:sns:us-east-2:001464217116:AmazonTextractTopic1608797699073"
        self.bucket = bucket
        ...
        while finished == False:
            ...
            if self.processType == ProcessType.ANALYSIS:
                if paginationToken == None:
                    ...
                    response = self.textract.get_documstart_document_analysisent_analysis(JobId=jobId,
                                                                   MaxResults=maxResults,
